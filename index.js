...
app.get("/CRM/showServiceAdvisor",managerAuth, async function (request, response) {
  const getData = await client
    .db("CRM")
    .collection("serviceAdvisorData")
    .find({})
...
app.get("/CRM/showTechnicians",managerAuth, async function (request, response) {
  const getData = await client
    .db("CRM")
    .collection("techniciansData")
    .find({})
...
app.get("/CRM/showServiceRequests",managerAuth, async function (request, response) {
  const getData = await client
    .db("CRM")
    .collection("serviceLeads")
    .find({})
...
app.post("/CRM/addLeads", async function (request, response) {
  ...
  app.post("/CRM/signUpManager", async function (request, response) {
    ...
    if (serviceRequestData) {
      ...
      const result = await client.db("CRM").collection("Manager Sign Up").insertOne({
        name: name,
        email: email,
